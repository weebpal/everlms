...
class NotificationManager implements NotificationManagerInterface {
  ...
  public function createNotification(array $notificationData) {
    ...
    $notification = $this->entityTypeManager->getStorage('we_notification')->create([
      'type' => 'default',
  ...
  public function loadNotification($notificationId) {
    return $this->entityTypeManager->getStorage('we_notification')->load($notificationId);
  }
  ...
  public function markReadNotification($notificationId) {
    $notification = \Drupal::entityTypeManager()->getStorage('we_notification')->load($notificationId);
    if ($notification) {
